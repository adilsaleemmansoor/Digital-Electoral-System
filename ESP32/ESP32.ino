...
// Wi-Fi credentials
const char* ssid = "Baig";
const char* password = "Uskt2025";

// Server URL for sending data
const String serverUrl = "http://192.168.161.102/upload.php"; // Android device IP and port
